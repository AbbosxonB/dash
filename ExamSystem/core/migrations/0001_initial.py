# Generated by Django 5.2.7 on 2025-12-07 13:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question_type', models.CharField(choices=[('MCQ', 'Multiple Choice'), ('TF', 'True/False'), ('ESSAY', 'Essay')], default='MCQ', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='subjects_created', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Test',
            fields=[
                ...
                ('total_time_minutes', models.IntegerField(default=60)),
